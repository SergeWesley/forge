...
public class ArtService extends BaseExternalService {
    ...
    private static final String IMAGE_BASE_URL = "https://www.artic.edu/iiif/2/%s/full/843,/0/default.jpg";
    ...
    private List<ArtItem> mapToArtItems(ArtResponse response) {
        ...
        return response.data().stream()
                ...
                .map(data -> new ArtItem(
                        data.id(),
                        data.title(),
                        data.artistTitle() != null ? data.artistTitle() : "Unknown Artist",
