...
/**
 * Extended Command interface for commands that require session/user context. Session-aware commands
 * have access to the user's principal name to perform user-specific operations.
 */
